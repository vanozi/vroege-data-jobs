...
class Koe(CreatedTimestampMixin, TimestampMixin, SQLModel,table=True):
    ...
    animal_id: UUID = Field(
        ...
        sa_column_kwargs={"comment": "Unieke UUID voor identificatie van de koe in het systeem"}
    )
    ...
    eartag: str = Field(
        ...
        sa_column_kwargs={"comment": "Oormerknummer - officiële unieke identificatie volgens I&R"}
    )
    ...
    name: str = Field(
        description="Naam van de koe",
        sa_column_kwargs={"comment": "Naam van de koe"}
    )
    collar_number: int = Field(
        alias="number",
        description="Halsbandnummer van de koe voor makkelijke herkenning in de stal",
        sa_column_kwargs={"comment": "Halsbandnummer van de koe voor makkelijke herkenning in de stal"}
    )
    ...
    eartag_short: str = Field(
        ...
        sa_column_kwargs={"comment": "Verkorte versie van het oormerknummer voor eenvoudige weergave"}
    )
    ...
    in_current_herd: bool = Field(
        ...
        sa_column_kwargs={"comment": "Indicator of de koe nog actief in de huidige kudde aanwezig is"}
    )
...
class KoeDetail(SQLModel, table=True):
    ...
    animal_id: UUID = Field(
        ...
        sa_column_kwargs={"comment": "Foreign key naar de koeien tabel - unieke identificatie"}
    )
    ...
    previous_number: Optional[int] = Field(
        ...
        sa_column_kwargs={"comment": "Vorig halsbandnummer voordat de koe een nieuw nummer kreeg"}
    )
    transponder_number: Optional[int] = Field(
        default=None,
        alias="transponder1",
        sa_column=Column(BigInteger, comment="Transponder/chip nummer voor elektronische identificatie"),
    ...
    feeding_group_name: Optional[str] = Field(
        ...
        sa_column_kwargs={"comment": "Naam van de voedergroep waarin de koe is ingedeeld"}
    )
    ...
    last_herd_id: Optional[UUID] = Field(
        ...
        sa_column_kwargs={"comment": "ID van de laatste kudde waarin de koe was ingedeeld"}
    )
    ...
    status: Optional[str] = Field(
        ...
        sa_column_kwargs={"comment": "Huidige status (bijv. droog, lactatie, gust, drachtig)"}
    )
    ...
    expected_dry_off_date: Optional[datetime] = Field(
        default=None,
    ...
    last_insemination_date: Optional[datetime] = Field(
        default=None,
    ...
    lactation_number: Optional[int] = Field(
        ...
        sa_column_kwargs={"comment": "Lactatienummer (1 = eerste lactatie, 2 = tweede, etc.)"}
    )
    ...
    lactation_total_milk: Optional[float] = Field(
        ...
        sa_column_kwargs={"comment": "Totale melkproductie in de huidige lactatie in kg"}
    )
    ...
    is_young_stock: bool = Field(
        ...
        sa_column_kwargs={"comment": "Indicator of het jongvee betreft (nog niet afgekalfd)"}
    )
    to_be_culled: bool = Field(
        default=False,
        alias="toBeCulled",
        description="Indicator of de koe is gemarkeerd voor selectie/afvoer",
        sa_column_kwargs={"comment": "Indicator of de koe is gemarkeerd voor selectie/afvoer"}
    )
    aborted: bool = Field(
        default=False,
        description="Indicator of de koe heeft geaborteerd in de huidige dracht",
        sa_column_kwargs={"comment": "Indicator of de koe heeft geaborteerd in de huidige dracht"}
    )
    barren: bool = Field(
        default=False,
    ...
    is_beef: bool = Field(
        ...
        sa_column_kwargs={"comment": "Indicator of het een vleeskoe betreft (niet melk)"}
    )
